...
Once the `conda-forge` channel has been enabled, `apischema` can be installed with:

```
conda install apischema
```

It is possible to list all of the versions of `apischema` available on your platform with:
